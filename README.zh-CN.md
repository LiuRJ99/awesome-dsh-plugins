...
| [`dsh-decision-engine`](https://github.com/LiuRJ99/dsh-decision-engine) | 面向 DSH 的模型中立低延迟决策层：提供可插拔决策引擎与 Provider、有限候选集决策协议，以及 Browser / Computer / Custom 环境适配器 | Git release tag `v0.4.0` | DSH peer 服务；可选 `@receptron/laya` 提供本地推理；若启用 browser/computer 适配器需相应宿主工具/插件支持 |
...
dsh plugin --profile <candidate-profile> add \
  "github:LiuRJ99/dsh-decision-engine#498bdfff07517a561d2936fa47a304f3143aaf32"
dsh plugin --profile <candidate-profile> add \
