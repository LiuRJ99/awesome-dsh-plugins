...
| `@yuxianglin/dsh-bridge-browser` | 0.0.4 | 浏览器控制 | [github.com/LiuRJ99/dsh-browser](https://github.com/LiuRJ99/dsh-browser)（[Lum1104/dsh-browser](https://github.com/Lum1104/dsh-browser) 的 fork；同步源版本 workspace v0.1.2 / bridge v0.0.3；当前 workspace/扩展 v0.1.3） |
